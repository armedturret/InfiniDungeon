...
#ifndef SpriteFontm_hm_m_
#define SpriteFontm_hm_m_
...
#define FIRSTm_PRINTABLEm_CHAR ((char)32)
#define LASTm_PRINTABLEm_CHAR ((char)126)
	...
	public:
		...
		SpriteFont(const char* font, int size) :
			SpriteFont(font, size, FIRSTm_PRINTABLEm_CHAR, LASTm_PRINTABLEm_CHAR) {
		}
